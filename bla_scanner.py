"""bla_scanner.py - Scan for BLE advertisements from "kikicker" devices and analyze payloads.
...
Tested on Windows, Ubuntu, and Raspberry Pi OS.

Scans for:
TARGET_NAME = "kikicker"
TARGET_COMPANY_ID = 0x1337

Measures only deltas between distinct advertisements.

Supports --raw mode for hex output and human-readable mode that decodes the payload into a structured format.
...
if __name__ == "__main__":
    ...
    print(f"Starting bla_scanner in {mode_text} mode...")
